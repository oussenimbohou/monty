...
Ubuntu 20.04 LTS via Vagrant in VirtualBox and compiled with GCC version 11.2.0
...
-   SimpleYour programs and functions will be compiled with gcc 11.2.0 using the flags -Wall -Werror -Wextra and -pedantic
